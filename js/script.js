...
if (menuToggle && navLinks) {
    ...
    // --- NUOVO: Chiudi il menu quando si clicca su un link ---
    // Questo serve per far partire lo smooth scroll senza che il menu copra la vista
...
// --- 2. MOTORE DI RICERCA E CREAZIONE CARD (Protetto per il Login) ---
// Esegue il codice della ricerca SOLO se la barra di ricerca è presente sulla pagina
if (searchInput) {
    searchInput.addEventListener('input', (e) => {
        ...
        // CASO B: L'utente ha cancellato tutto (barra tornata vuota)
            ...
            setTimeout(() => {
                // Siccome questo Timeout scatta dopo 0.5 secondi, riverifichiamo che la barra esista ancora e sia vuota
...
} // <--- Fine del controllo di sicurezza della ricerca
